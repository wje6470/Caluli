...
1. **Setup**: Run `C:\Users\user\AppData\Roaming\uv\tools\specify-cli\Scripts\python.exe .specify/scripts/python/check_prerequisites.py --json` from repo root and parse JSON for FEATURE_DIR and AVAILABLE_DOCS list.
