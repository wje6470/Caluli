...
import type { AdminStore, AdminStoreInput, AdminStoreWithCount } from '@/lib/api/types'

const STORES_KEY = ['admin', 'stores']

export default function AdminStoresPage() {
  const queryClient = useQueryClient()
  const [editing, setEditing] = useState<AdminStore | null | undefined>(undefined)
  const [deleting, setDeleting] = useState<AdminStoreWithCount | null>(null)
  ...
  const save = useMutation({
    mutationFn: (input: AdminStoreInput) =>
